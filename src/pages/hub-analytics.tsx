 ...
 * reports, P&L, daily ops, VAT report, eTIMS queue, tips report.
 *
...
import { LayoutDashboard, BarChart3, LineChart, ClipboardList, FileSpreadsheet, Send, Coins } from "lucide-react";
  ...
  return (
    <HubLayout
      ...
      tabs={[
        ...
        { id: "reports", label: "Sales reports", icon: BarChart3, component: ReportsPage, permission: "reports.view" },
