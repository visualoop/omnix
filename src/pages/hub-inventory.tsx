 ...
 *
 * Tabs across products, transfers, purchases, stock take, suppliers.
 * /inventory (Products list) stays the direct deep-link.
 */
import { useAuthStore } from "@/stores/auth";
import { hasPermission, type Permission } from "@/lib/permissions";
import { Package, ArrowLeftRight, Truck, ClipboardCheck, Building2 } from "lucide-react";
