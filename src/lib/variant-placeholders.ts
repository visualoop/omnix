...
export const VARIANT_PLACEHOLDERS: Record<Variant, VariantPlaceholders> = {
  ...
  hospitality: {
    productName: "e.g. Beef Stew, Ugali, Tusker Lager 500ml, Margherita Pizza",
    productSku: "e.g. MENU-BEEFSTEW",
    productCategory: "e.g. Mains, Drinks, Starters, Desserts",
    productDescription: "Ingredients, allergens, prep notes for the kitchen…",
    customerName: "e.g. Walk-in / Suite 204 / Mr Otieno",
    customerEmail: "guest@example.co.ke",
    inventorySearch: "Search menu, table, room, folio…",
