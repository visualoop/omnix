...
const pages: PageItem[] = [
  ...
  { type: "page", name: "Inventory", to: "/inventory", icon: SquaresFour, keywords: "products stock" },
  ...
  // v0.30-v0.34 additions — new pages need to be findable via command palette.
  { type: "page", name: "Notifications", to: "/notifications", icon: FileText, keywords: "alerts inbox unread bell" },
  { type: "page", name: "Two-factor authentication", to: "/settings/2fa", icon: Shield, keywords: "2fa totp authenticator security" },
  { type: "page", name: "Chart of Accounts", to: "/accounting/chart-of-accounts", icon: BarChart3, keywords: "coa ledger accounts" },
  { type: "page", name: "Trial Balance", to: "/accounting/trial-balance", icon: BarChart3, keywords: "gl debits credits balance" },
  { type: "page", name: "Balance Sheet", to: "/accounting/balance-sheet", icon: BarChart3, keywords: "assets liabilities equity" },
  { type: "page", name: "Cash Flow Statement", to: "/accounting/cash-flow", icon: BarChart3, keywords: "operating investing financing" },
  { type: "page", name: "Period Close", to: "/accounting/period-close", icon: FileText, keywords: "financial year lock month" },
  { type: "page", name: "Fixed Assets", to: "/accounting/fixed-assets", icon: FileText, keywords: "depreciation register" },
  { type: "page", name: "Cost Centres", to: "/accounting/cost-centres", icon: FileText, keywords: "projects departments campaigns" },
  { type: "page", name: "Approvals", to: "/approvals", icon: FileCheck, keywords: "purchase order expense sign off" },
  { type: "page", name: "Debit Notes", to: "/procurement/debit-notes", icon: Receipt, keywords: "supplier returns adjustment" },
  { type: "page", name: "Reservations", to: "/hospitality/reservations", icon: CalendarClock, keywords: "booking table room" },
  { type: "page", name: "Kitchen Display", to: "/hospitality/kitchen", icon: FileText, keywords: "kds tickets orders bump" },
  { type: "page", name: "Room Status", to: "/hospitality/rooms", icon: FileText, keywords: "housekeeping clean dirty" },
  { type: "page", name: "Reorder Suggestions", to: "/inventory/reorder", icon: SparkleIcon, keywords: "purchase suggestions velocity" },
  { type: "page", name: "Stock Aging", to: "/reports/stock-aging", icon: BarChart3, keywords: "old batches shelf time" },
  { type: "page", name: "Dead Stock", to: "/reports/dead-stock", icon: BarChart3, keywords: "no sales inventory tied up" },
  { type: "page", name: "Sales Targets", to: "/people/sales-targets", icon: BarChart3, keywords: "commissions bonus staff performance" },
  { type: "page", name: "Analytics", to: "/reports/analytics", icon: BarChart3, keywords: "dashboards sales inventory purchases finance" },
  { type: "page", name: "Currencies", to: "/settings/currencies", icon: Settings, keywords: "fx exchange rate multi-currency" },
  { type: "page", name: "Peripherals", to: "/settings/peripherals", icon: Settings, keywords: "cash drawer scale kitchen printer" },
  { type: "page", name: "Follow-ups", to: "/crm/follow-ups", icon: CalendarClock, keywords: "reminders todo customer chase" },
  { type: "page", name: "Deliveries", to: "/deliveries", icon: Truck, keywords: "rider dispatch home delivery" },
  { type: "page", name: "Bank Reconciliation", to: "/banking", icon: Banknote, keywords: "statement match variance bank" },
  { type: "page", name: "Recalls", to: "/pharmacy/recalls", icon: AlertTriangle, keywords: "quarantine kemsa moh batch" },
  { type: "page", name: "Data Quality", to: "/data-quality", icon: AlertTriangle, keywords: "duplicates orphans issues clean" },
  { type: "page", name: "Anomaly Alerts", to: "/anomalies", icon: AlertTriangle, keywords: "sales drop expiry spike variance" },
];
