...
interface CartPayload {
  ...
  sourceType: "hospitality_order" | "prescription" | "layby" | "special_order" | "folio" | "hardware_quote" | "salon_appointment" | "salon_package" | null;
...
interface CartState {
  ...
  setSource: (source: { type: "hospitality_order" | "prescription" | "layby" | "special_order" | "folio" | "hardware_quote" | "salon_appointment" | "salon_package"; id: string; label: string } | null) => void;
  ...
  loadSnapshot: (
    ...
    options?: {
      ...
      tipEmployeeId?: string | null;
      serviceChargeAmount?: number;
      source?: { type: "hospitality_order" | "prescription" | "layby" | "special_order" | "folio" | "hardware_quote" | "salon_appointment" | "salon_package"; id: string; label: string } | null;
    },
  ) => void;
  clear: () => void;
  subtotal: () => number;
