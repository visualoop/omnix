...
export const metadata: Metadata = {
  ...
  description: 'The legal agreement between you and Duka.',
}
...
export default function TermsPage() {
  return (
    <LegalLayout
      ...
      sections={[
        { id: 'agreement', heading: 'Agreement', body: <p>By downloading, installing, or using Duka, you agree to these terms. If you don&rsquo;t agree, don&rsquo;t use the software.</p> },
        { id: 'licence', heading: 'Licence', body: <><p>We grant you a non-exclusive, non-transferable licence to use Duka on the number of machines specified in your licence tier (3 for trial, 10 for standard, unlimited for custom).</p><p>You may not reverse-engineer, decompile, or redistribute Duka. You may not use Duka to violate any law.</p></> },
        ...
        { id: 'warranty', heading: 'Warranty disclaimer', body: <p>Duka is provided "as is" without warranty of any kind. We don&rsquo;t guarantee it will be error-free or uninterrupted. Use at your own risk.</p> },
        ...
        { id: 'termination', heading: 'Termination', body: <p>We may terminate your licence if you violate these terms. You may stop using Duka at any time. Termination doesn&rsquo;t entitle you to a refund after the 14-day window.</p> },
