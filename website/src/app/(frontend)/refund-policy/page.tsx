  ...
  return (
    <LegalLayout
      ...
      sections={[
        ...
        { id: 'window', heading: '14-day refund window', body: <><p>If you pay and decide within 14 days that Omnix isn&rsquo;t the right fit, we refund the full amount minus the Paystack processing fee (~2.9% + KES 100).</p><p>Email hello@omnix.co.ke with your licence key and reason. We process refunds within 5 business days.</p></> },
