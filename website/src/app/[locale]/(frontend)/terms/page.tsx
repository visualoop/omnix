  ...
  return (
    <LegalLayout
      ...
      sections={[
        ...
        { id: 'payment', heading: 'Payment', body: <><p>Trade-variant licences (Dawa, Retail, Hospitality, Hardware) are KES 30,000 one-time each. The Pro multi-trade licence is KES 150,000 one-time. Payment via M-Pesa or card through Paystack. Licences are perpetual — you own them forever.</p><p>Maintenance (bug fixes, statutory updates) is free for the lifetime of the major version you bought. Major-version upgrades (v2, v3) are 50% off list price for current owners.</p></> },
